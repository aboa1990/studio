...
import { Plus, Search, Quote, MoreHorizontal, Eye, Edit, Trash2 } from "lucide-react"
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-4xl font-headline font-black tracking-tight">Quotations</h1>
          <p className="text-muted-foreground mt-1">Create and manage client proposals.</p>
        </div>
        <Button asChild className="bg-accent text-accent-foreground hover:bg-accent/90">
          <Link href="/quotations/new"><Plus className="mr-2 size-4" /> New Quotation</Link>
        </Button>
      </div>
